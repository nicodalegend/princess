...
function applyConfig() {
  ...
  // Techdom — unlocks automatically once techdomUrl is set. The footer
  // link isn't included here: Techdom works as an in-page popup, not a
  // separate hub page, so its footer link is a permanent anchor to the
  // card (see index.html) rather than something waiting on a URL.
  unlockWhenReady({
